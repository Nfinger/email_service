    ...
    match SubscriberEmail::parse(email.clone()) {
        ...
        Err(e) => {
            tracing::error!(
                error.cause_chain = ?e,
                error.message = %e,
                "Skipping a confirmed subscriber. Invalid email address",
            );
        }
    }
...
#[tracing::instrument(name = "Dequeue a task", skip_all)]
...
#[tracing::instrument(name = "Fetch newsletter issue", skip_all)]
